...
bool PERFECT_VALUE_PRED      = false;  //mona.lisa2 for task6 p4
bool VALUE_PRED_EN           = false;  //mona.lisa2 for task6 p4
uint64_t VPQsize             = 0;      //mona.lisa2 for task6 p4
bool oracleConf              = false;  //mona.lisa2 for task6 p4
uint64_t SVPIndexBits         = 0;      //mona.lisa2 for task6 p4
uint64_t SVPTagBits           = 0;      //mona.lisa2 for task6 p4
uint64_t confMax              = 0;      //mona.lisa2 for task6 p4
uint64_t confInc              = 0;      //mona.lisa2 for task6 p4
uint64_t confDec              = 0;      //mona.lisa2 for task6 p4
uint64_t replace_stride       = 0;      //mona.lisa2 for task6 p4
uint64_t Replace              = 0;      //mona.lisa2 for task6 p4
bool predINTALU              = false;  //mona.lisa2 for task6 p4
bool predFPALU               = false;  //mona.lisa2 for task6 p4
bool predLOAD                = false;  //mona.lisa2 for task6 p4
bool VPQ_full_policy         = false;  //mona.lisa2 for task6 p4
