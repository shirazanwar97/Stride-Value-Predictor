...
extern bool VALUE_PRED_EN;  //mona.lisa2 for task6 p4
extern bool PERFECT_VALUE_PRED;  //mona.lisa2 for task6 p4
extern uint64_t VPQsize;             //mona.lisa2 for task6 p4
extern bool oracleConf;             //mona.lisa2 for task6 p4
extern uint8_t SVPIndexBits;             //mona.lisa2 for task6 p4
extern uint8_t SVPTagBits;             //mona.lisa2 for task6 p4
extern uint8_t confMax;             //mona.lisa2 for task6 p4
extern uint8_t confInc;             //mona.lisa2 for task6 p4
extern uint8_t confDec;             //mona.lisa2 for task6 p4
extern uint8_t replace_stride;             //mona.lisa2 for task6 p4
extern uint8_t Replace;             //mona.lisa2 for task6 p4
extern bool predINTALU;             //mona.lisa2 for task6 p4
extern bool predFPALU;             //mona.lisa2 for task6 p4
extern bool predLOAD;             //mona.lisa2 for task6 p4
extern bool VPQ_full_policy;             //mona.lisa2 for task6 p4
...
extern int64_t vpmeas_ineligible_type ;
extern int64_t vpmeas_ineligible_drop ;
extern int64_t vpmeas_ineligible      ;
extern int64_t vpmeas_eligible        ;
extern int64_t vpmeas_miss            ;
extern int64_t vpmeas_conf_corr       ;
extern int64_t vpmeas_conf_incorr     ;
extern int64_t vpmeas_unconf_corr     ;
extern int64_t vpmeas_unconf_incorr   ;
