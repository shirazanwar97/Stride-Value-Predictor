...
#include "valuePredictor.h"  //Value Prediction mona.lisa2 for p4
...
//For value prediction eligibility criteria
...
private:
  ...
  stats_t*  stats;  //Pointer to the statsModule required by macros
	...
	/////////////////////////////////////////////////////////////
	// Value Predictor module.  mona.lisa2 for p4
	/////////////////////////////////////////////////////////////
	StrideValuePredictor* VP;
