...
void pipeline_t::writeback(unsigned int lane_number) {
   ...
   if (Execution_Lanes[lane_number].wb.valid) {
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////////
      // cout << "WB PC a = " << PAY.buf[index].pc << "\t" << PAY.buf[index].A_phys_reg << "\t" << PAY.buf[index].A_value.dw << "\t" <<  endl;
      ...
      if (PAY.buf[index].checkpoint) {
	    ...
	    // FIX_ME #15b END
            ...
            // restore the VPQ===============================================================        
            VP->rollback(PAY.buf[index].VPQTail, PAY.buf[index].VPQTailPhase);
            // ==============================================================================
      ...
      // if(PAY.buf[index].C_valid && PAY.buf[index].isVPEligible && (!PERFECT_VALUE_PRED) && (!(oracleConf))){
